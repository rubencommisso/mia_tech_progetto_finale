  ...
  return (
    <div className=" p-6 font-sans m-16 bg-white-200">
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold text-green-600 text-center mb-20 mt-28 underline  first-letter:text-4xl first-letter:text-gray-500">
            ...
            <div key={product.id} className="bg-white p-6 rounded-lg ">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="md:w-1/3 flex flex-col justify-center text-center md:text-left">
                 ...
                 <span className=" block font-bold text-green-900 text-8xl mt-20 text-center">{product.plasticSaved}% <p className="text-lg text-gray-500 mt-2">Risparmio di plastica</p></span>
                </div>
